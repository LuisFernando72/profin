...
//                    console.log(element);
    ...
    viewData() {
        ...
        if (this.selected.length == 1) {
            ...
            btn_act_cliente.addEventListener("click", llenarCampo(idCliente));
...
function llenarCampo(idCliente) {

    const NombreCliente = document.querySelector("#txt_idRegistro");
...
//const txtapellidosEmergenciaM = document.querySelector("#txtapellidosEmergenciaM");
    NombreCliente.value = idCliente;
